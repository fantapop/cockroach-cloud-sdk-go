...
* `CREATE_CLUSTER_BLACKOUT_WINDOW` (value: `"AUDIT_LOG_ACTION_CREATE_CLUSTER_BLACKOUT_WINDOW"`)

* `UPDATE_CLUSTER_BLACKOUT_WINDOW` (value: `"AUDIT_LOG_ACTION_UPDATE_CLUSTER_BLACKOUT_WINDOW"`)
...
* `ENABLE_MFA_ENFORCEMENT` (value: `"AUDIT_LOG_ACTION_ENABLE_MFA_ENFORCEMENT"`)

* `DISABLE_MFA_ENFORCEMENT` (value: `"AUDIT_LOG_ACTION_DISABLE_MFA_ENFORCEMENT"`)

* `RESET_USER_MFA` (value: `"AUDIT_LOG_ACTION_RESET_USER_MFA"`)

* `ENROLL_USER_MFA` (value: `"AUDIT_LOG_ACTION_ENROLL_USER_MFA"`)
