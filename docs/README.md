...
[EgressPrivateEndpointsApi](docs/EgressPrivateEndpointsApi.md) | **GetEgressPrivateEndpoint** | **Get** /api/v1/clusters/{cluster_id}/networking/egress-private-endpoints/{id} | Get egress private endpoint
...
[EgressPrivateEndpointsApi](docs/EgressPrivateEndpointsApi.md) | **UpdateEgressPrivateEndpoint** | **Patch** /api/v1/clusters/{cluster_id}/networking/egress-private-endpoints/{id} | Update egress private endpoint.
[EgressPrivateEndpointsApi](docs/EgressPrivateEndpointsApi.md) | **UpdateEgressPrivateEndpointDomainNames** | **Patch** /api/v1/clusters/{cluster_id}/networking/egress-private-endpoints/{id}/domain-names | Update egress private endpoint domain names. This endpoint is deprecated in favor of PATCH /api/v1/clusters/{cluster_id}/networking/egress-private-endpoints/{id} and will be removed in a future version.
