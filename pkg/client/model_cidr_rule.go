...
// CidrRule CidrRule supplies and optionally exposes the GCP network range..
type CidrRule struct {
	// settable permits the creator to override value.
	Settable *bool `json:"settable,omitempty"`
	// value is the environment-supplied cidr_range.
